            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    className="bg-white border-gray-300 force-bg"
                    maxLength={200}
                  />
                  <Button 
                    variant="outline"
                    ...
                    className={cn(UI_STYLES.button.secondary, "force-bg")}
                ...
                <div className="text-sm font-medium flex justify-between items-center text-gray-700">
                  ...
                  {imageIds.length > 0 && (
                    <Button 
                      variant="outline"
                      size="sm" 
                      className={cn("h-8 force-bg", UI_STYLES.button.danger)}
                ...
                <div className={cn("divide-y rounded-md overflow-hidden force-bg", UI_STYLES.card)}>
                  {imageIds.length === 0 ? (
                    ...
                    imageIds.map((id, index) => (
                      <div 
                        key={index} 
                        className={cn("p-3 flex items-center justify-between force-bg", UI_STYLES.bgPanel)}
                      >
                        ...
                        <div className="flex gap-1">
                          <a 
                            ...
                            className="text-blue-600 hover:text-blue-800 p-1 rounded hover:bg-blue-50 force-bg"
                          ...
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-6 w-6 rounded-full text-red-500 hover:bg-red-50 hover:text-red-700 force-bg"
              ...
              <div className="flex justify-end pt-2">
                <Button
                  ...
                  className={cn("mr-2 force-bg", UI_STYLES.button.secondary)}
                >
                  Cancel
                </Button>
                <Button 
                  ...
                  className={cn("force-bg", UI_STYLES.button.secondary)}
                >
